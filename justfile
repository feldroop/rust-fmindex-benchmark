...
run_all:
    ...
    cargo run --release -- lt-fm-index128 {{num_text_records}} {{suffix_array_sampling_rate}} {{depth_of_lookup_table}} {{num_queries_records}} {{length_of_queries}} {{search_mode}} {{skip_build}} {{force_write_and_load}}
